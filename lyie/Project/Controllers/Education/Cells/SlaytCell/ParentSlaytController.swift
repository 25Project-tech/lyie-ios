...
final class ParentSlaytController: PageboyViewController {
    ...
    override func viewDidLoad() {
        ...
        pageControl.numberOfPages = pageCountValue
    ...
    func makeChildViewController(at index: Int?) -> UIViewController {
        let childVc: ChildSlaytVC = UIStoryboard.education.instantiateViewController() as ChildSlaytVC
        childVc.pageIndex = index!
        childVc.i = pageCountValue
        childVc.childEducationIndex = childEducationIndex
        childVc.isHiddenValue = isHiddenValue
        return childVc
    }
}

//MARK: - PageboyViewControllerDataSource, PageboyViewControllerDelegate
extension ParentSlaytController: PageboyViewControllerDataSource, PageboyViewControllerDelegate {
